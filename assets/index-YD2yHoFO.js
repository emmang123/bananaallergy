...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function tu(){return new bi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:rc(),fragmentShader:`
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function nu(){return new bi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:rc(),fragmentShader:`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var tt;(function(i){i[i.DEBUG=0]="DEBUG",i[i.VERBOSE=1]="VERBOSE",i[i.INFO=2]="INFO",i[i.WARN=3]="WARN",i[i.ERROR=4]="ERROR",i[i.SILENT=5]="SILENT"})(tt||(tt={}));const nb={debug:tt.DEBUG,verbose:tt.VERBOSE,info:tt.INFO,warn:tt.WARN,error:tt.ERROR,silent:tt.SILENT},ib=tt.INFO,sb={[tt.DEBUG]:"log",[tt.VERBOSE]:"log",[tt.INFO]:"info",[tt.WARN]:"warn",[tt.ERROR]:"error"},rb=(i,e,...t)=>{if(e<i.logLevel)return;const n=new Date().toISOString(),s=sb[e];if(s)console[s](`[${n}]  ${i.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class cp{constructor(e){this.name=e,this._logLevel=ib,this._logHandler=rb,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in tt))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?nb[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,tt.DEBUG,...e),this._logHandler(this,tt.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,tt.VERBOSE,...e),this._logHandler(this,tt.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,tt.INFO,...e),this._logHandler(this,tt.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,tt.WARN,...e),this._logHandler(this,tt.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,tt.ERROR,...e),this._logHandler(this,tt.ERROR,...e)}}const ab=(i,e)=>e.some(t=>i instanceof t);let pd,md;function ob(){return pd||(pd=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function lb(){return md||(md=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const hp=new WeakMap,Vl=new WeakMap,up=new WeakMap,ll=new WeakMap,bc=new WeakMap;function cb(i){const e=new Promise((t,n)=>{const s=()=>{i.removeEventListener("success",r),i.removeEventListener("error",a)},r=()=>{t(xi(i.result)),s()},a=()=>{n(i.error),s()};i.addEventListener("success",r),i.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&hp.set(t,i)}).catch(()=>{}),bc.set(e,i),e}function hb(i){if(Vl.has(i))return;const e=new Promise((t,n)=>{const s=()=>{i.removeEventListener("complete",r),i.removeEventListener("error",a),i.removeEventListener("abort",a)},r=()=>{t(),s()},a=()=>{n(i.error||new DOMException("AbortError","AbortError")),s()};i.addEventListener("complete",r),i.addEventListener("error",a),i.addEventListener("abort",a)});Vl.set(i,e)}let zl={get(i,e,t){if(i instanceof IDBTransaction){if(e==="done")return Vl.get(i);if(e==="objectStoreNames")return i.objectStoreNames||up.get(i);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return xi(i[e])},set(i,e,t){return i[e]=t,!0},has(i,e){return i instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in i}};function ub(i){zl=i(zl)}function db(i){return i===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const n=i.call(cl(this),e,...t);return up.set(n,e.sort?e.sort():[e]),xi(n)}:lb().includes(i)?function(...e){return i.apply(cl(this),e),xi(hp.get(this))}:function(...e){return xi(i.apply(cl(this),e))}}function fb(i){return typeof i=="function"?db(i):(i instanceof IDBTransaction&&hb(i),ab(i,ob())?new Proxy(i,zl):i)}function xi(i){if(i instanceof IDBRequest)return cb(i);if(ll.has(i))return ll.get(i);const e=fb(i);return e!==i&&(ll.set(i,e),bc.set(e,i)),e}const cl=i=>bc.get(i);function pb(i,e,{blocked:t,upgrade:n,blocking:s,terminated:r}={}){const a=indexedDB.open(i,e),o=xi(a);return n&&a.addEventListener("upgradeneeded",l=>{n(xi(a.result),l.oldVersion,l.newVersion,xi(a.transaction),l)}),t&&a.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),o.then(l=>{r&&l.addEventListener("close",()=>r()),s&&l.addEventListener("versionchange",c=>s(c.oldVersion,c.newVersion,c))}).catch(()=>{}),o}const mb=["get","getKey","getAll","getAllKeys","count"],gb=["put","add","delete","clear"],hl=new Map;function gd(i,e){if(!(i instanceof IDBDatabase&&!(e in i)&&typeof e=="string"))return;if(hl.get(e))return hl.get(e);const t=e.replace(/FromIndex$/,""),n=e!==t,s=gb.includes(t);if(!(t in(n?IDBIndex:IDBObjectStore).prototype)||!(s||mb.includes(t)))return;const r=async function(a,...o){const l=this.transaction(a,s?"readwrite":"readonly");let c=l.store;return n&&(c=c.index(o.shift())),(await Promise.all([c[t](...o),s&&l.done]))[0]};return hl.set(e,r),r}ub(i=>({...i,get:(e,t,n)=>gd(e,t)||i.get(e,t,n),has:(e,t)=>!!gd(e,t)||i.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $s="12.13.0";function hT(i){$s=i}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(i,e,t){let n="Unexpected state";typeof e=="string"?n=e:t=e,_p(i,n,t)}function _p(i,e,t){let n=`FIRESTORE (${$s}) INTERNAL ASSERTION FAILED: ${e} (ID: ${i.toString(16)})`;if(t!==void 0)try{n+=" CONTEXT: "+JSON.stringify(t)}catch{n+=" CONTEXT: "+t}throw Tc(n),new Error(n)}function hn(i,e,t,n){let s="Unexpected state";typeof t=="string"?s=t:n=t,i||_p(e,s,n)}function Fr(i,e){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vp{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class uT{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(tn.UNAUTHENTICATED))}shutdown(){}}class dT{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class fT{constructor(e){this.auth=null,e.onInit(t=>{this.auth=t})}getToken(){return this.auth?this.auth.getToken().then(e=>e?(hn(typeof e.accessToken=="string",42297,{t:e}),new vp(e.accessToken,new tn(this.auth.getUid()))):null):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}class pT{constructor(e,t,n){this.i=e,this.o=t,this.u=n,this.type="FirstParty",this.user=tn.FIRST_PARTY,this.l=new Map}h(){return this.u?this.u():null}get headers(){this.l.set("X-Goog-AuthUser",this.i);const e=this.h();return e&&this.l.set("Authorization",e),this.o&&this.l.set("X-Goog-Iam-Authorization-Token",this.o),this.l}}class mT{constructor(e,t,n){this.i=e,this.o=t,this.u=n}getToken(){return Promise.resolve(new pT(this.i,this.o,this.u))}start(e,t){e.enqueueRetryable(()=>t(tn.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Sd{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class gT{constructor(e,t){this.m=t,this.appCheck=null,this.P=null,Kb(e)&&e.settings.appCheckToken&&(this.P=e.settings.appCheckToken),t.onInit(n=>{this.appCheck=n})}getToken(){return this.P?Promise.resolve(new Sd(this.P)):this.appCheck?this.appCheck.getToken().then(e=>e?(hn(typeof e.token=="string",3470,{tokenResult:e}),new Sd(e.token)):null):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DA(i,e,t){let n;return n=i?t&&(t.merge||t.mergeFields)?i.toFirestore(e,t):i.toFirestore(e):e,n}class Kp extends IA{constructor(e){super(),this.firestore=e}convertBytes(e){return new vn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new At(this.firestore,null,t)}}function NA(i){const e=Cc((i=no(i,At)).firestore),t=new Kp(i.firestore);return pA(e,[i._key]).then(n=>{hn(n.length===1,15618);const s=n[0];return new qp(i.firestore,t,i._key,s.isFoundDocument()?s:null,i.converter)})}function UA(i){(function(s){if(s.limitType==="L"&&s.explicitOrderBy.length===0)throw new me(se.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")})((i=no(i,Ti))._query);const e=Cc(i.firestore),t=new Kp(i.firestore);return mA(e,i._query).then(n=>{const s=n.map(r=>new $p(i.firestore,t,r.key,r,i.converter));return i._query.limitType==="L"&&s.reverse(),new RA(i,s)})}function OA(i,e,t){const n=DA((i=no(i,At)).converter,e,t),s=SA(Hp(i.firestore),"setDoc",i._key,n,i.converter!==null,t);return fA(Cc(i.firestore),[s.toMutation(i._key,_r.none())])}function Xd(){return new Ic("serverTimestamp")}const qd="4.14.1";(function(){hT(`${Zb}_lite`),Oa(new wr("firestore/lite",(e,{instanceIdentifier:t,options:n})=>{const s=e.getProvider("app").getImmediate(),r=new oo(new fT(e.getProvider("auth-internal")),new gT(s,e.getProvider("app-check-internal")),vT(s,t),s);return n&&r._setSettings(n),r},"PUBLIC").setMultipleInstances(!0)),Rs("firestore-lite",qd,""),Rs("firestore-lite",qd,"esm2020")})();var FA="firebase",BA="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
