...
void main() {
	...
	`}function qv(s){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===bl||l===Tl,h=l===Is||l===Ds;if(c||h)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let u=e.get(o);return t===null&&(t=new iu(s)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),e.set(o,u),u.texture}else{if(e.has(o))return e.get(o).texture;{const u=o.image;if(c&&u&&u.height>0||h&&u&&i(u)){t===null&&(t=new iu(s));const d=c?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,d),o.addEventListener("dispose",r),d.texture}else return null}}}return o}function i(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function jv(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const i=t(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Kv(s,e,t,n){const i={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const v=d.morphAttributes[g];for(let m=0,p=v.length;m<p;m++)e.remove(v[m])}d.removeEventListener("dispose",a),delete i[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return i[d.id]===!0||(d.addEventListener("dispose",a),i[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const g in d)e.update(d[g],s.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const v=f[g];for(let m=0,p=v.length;m<p;m++)e.update(v[m],s.ARRAY_BUFFER)}}function c(u){const d=[],f=u.index,g=u.attributes.position;let v=0;if(f!==null){const M=f.array;v=f.version;for(let y=0,T=M.length;y<T;y+=3){const N=M[y+0],L=M[y+1],x=M[y+2];d.push(N,L,L,x,x,N)}}else if(g!==void 0){const M=g.array;v=g.version;for(let y=0,T=M.length/3-1;y<T;y+=3){const N=y+0,L=y+1,x=y+2;d.push(N,L,L,x,x,N)}}else return;const m=new(_f(d)?bf:Sf)(d,1);m.version=v;const p=r.get(u);p&&e.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function Yv(s,e,t,n){const i=n.isWebGL2;let r;function a(f){r=f}let o,l;function c(f){o=f.type,l=f.bytesPerElement}function h(f,g){s.drawElements(r,g,o,f*l),t.update(g,r,1)}function u(f,g,v){if(v===0)return;let m,p;if(i)m=s,p="drawElementsInstanced";else if(m=e.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[p](r,g,o,f*l,v),t.update(g,r,v)}function d(f,g,v){if(v===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<v;p++)this.render(f[p]/l,g[p]);else{m.multiDrawElementsWEBGL(r,g,0,o,f,0,v);let p=0;for(let M=0;M<v;M++)p+=g[M];t.update(p,r,1)}}this.setMode=a,this.setIndex=c,this.render=h,this.renderInstances=u,this.renderMultiDraw=d}function Jv(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case s.TRIANGLES:t.triangles+=o*(r/3);break;case s.LINES:t.lines+=o*(r/2);break;case s.LINE_STRIP:t.lines+=o*(r-1);break;case s.LINE_LOOP:t.lines+=o*r;break;case s.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Zv(s,e){return s[0]-e[0]}function Qv(s,e){return Math.abs(e[1])-Math.abs(s[1])}function ey(s,e,t){const n={},i=new Float32Array(8),r=new WeakMap,a=new st,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,h,u){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const f=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,g=f!==void 0?f.length:0;let v=r.get(h);if(v===void 0||v.count!==g){let U=function(){C.dispose(),r.delete(h),h.removeEventListener("dispose",U)};v!==void 0&&v.texture.dispose();const M=h.morphAttributes.position!==void 0,y=h.morphAttributes.normal!==void 0,T=h.morphAttributes.color!==void 0,N=h.morphAttributes.position||[],L=h.morphAttributes.normal||[],x=h.morphAttributes.color||[];let S=0;M===!0&&(S=1),y===!0&&(S=2),T===!0&&(S=3);let b=h.attributes.position.count*S,_=1;b>e.maxTextureSize&&(_=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const E=new Float32Array(b*_*4*g),C=new xf(E,b,_,g);C.type=Bn,C.needsUpdate=!0;const w=S*4;for(let z=0;z<g;z++){const G=N[z],q=L[z],$=x[z],X=b*_*4*z;for(let J=0;J<G.count;J++){const Z=J*w;M===!0&&(a.fromBufferAttribute(G,J),E[X+Z+0]=a.x,E[X+Z+1]=a.y,E[X+Z+2]=a.z,E[X+Z+3]=0),y===!0&&(a.fromBufferAttribute(q,J),E[X+Z+4]=a.x,E[X+Z+5]=a.y,E[X+Z+6]=a.z,E[X+Z+7]=0),T===!0&&(a.fromBufferAttribute($,J),E[X+Z+8]=a.x,E[X+Z+9]=a.y,E[X+Z+10]=a.z,E[X+Z+11]=$.itemSize===4?a.w:1)}}v={count:g,texture:C,size:new ae(b,_)},r.set(h,v),h.addEventListener("dispose",U)}let m=0;for(let M=0;M<d.length;M++)m+=d[M];const p=h.morphTargetsRelative?1:1-m;u.getUniforms().setValue(s,"morphTargetBaseInfluence",p),u.getUniforms().setValue(s,"morphTargetInfluences",d),u.getUniforms().setValue(s,"morphTargetsTexture",v.texture,t),u.getUniforms().setValue(s,"morphTargetsTextureSize",v.size)}else{const f=d===void 0?0:d.length;let g=n[h.id];if(g===void 0||g.length!==f){g=[];for(let y=0;y<f;y++)g[y]=[y,0];n[h.id]=g}for(let y=0;y<f;y++){const T=g[y];T[0]=y,T[1]=d[y]}g.sort(Qv);for(let y=0;y<8;y++)y<f&&g[y][1]?(o[y][0]=g[y][0],o[y][1]=g[y][1]):(o[y][0]=Number.MAX_SAFE_INTEGER,o[y][1]=0);o.sort(Zv);const v=h.morphAttributes.position,m=h.morphAttributes.normal;let p=0;for(let y=0;y<8;y++){const T=o[y],N=T[0],L=T[1];N!==Number.MAX_SAFE_INTEGER&&L?(v&&h.getAttribute("morphTarget"+y)!==v[N]&&h.setAttribute("morphTarget"+y,v[N]),m&&h.getAttribute("morphNormal"+y)!==m[N]&&h.setAttribute("morphNormal"+y,m[N]),i[y]=L,p+=L):(v&&h.hasAttribute("morphTarget"+y)===!0&&h.deleteAttribute("morphTarget"+y),m&&h.hasAttribute("morphNormal"+y)===!0&&h.deleteAttribute("morphNormal"+y),i[y]=0)}const M=h.morphTargetsRelative?1:1-p;u.getUniforms().setValue(s,"morphTargetBaseInfluence",M),u.getUniforms().setValue(s,"morphTargetInfluences",i)}}return{update:l}}function ty(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=e.get(l,h);if(i.get(u)!==c&&(e.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return u}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}class Cf extends Rt{constructor(e,t,n,i,r,a,o,l,c,h){if(h=h!==void 0?h:Hi,h!==Hi&&h!==Ns)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Hi&&(n=_i),n===void 0&&h===Ns&&(n=zi),super(null,i,r,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:mt,this.minFilter=l!==void 0?l:mt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Pf=new Rt,Lf=new Cf(1,1);Lf.compareFunction=gf;const If=new xf,Df=new kg,Nf=new wf,ou=[],lu=[],cu=new Float32Array(16),hu=new Float32Array(9),uu=new Float32Array(4);function Ws(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=ou[i];if(r===void 0&&(r=new Float32Array(i),ou[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function Ct(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Pt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function to(s,e){let t=lu[e];t===void 0&&(t=new Int32Array(e),lu[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function ny(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function iy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ct(t,e))return;s.uniform2fv(this.addr,e),Pt(t,e)}}function sy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Ct(t,e))return;s.uniform3fv(this.addr,e),Pt(t,e)}}function ry(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ct(t,e))return;s.uniform4fv(this.addr,e),Pt(t,e)}}function ay(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ct(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Pt(t,e)}else{if(Ct(t,n))return;uu.set(n),s.uniformMatrix2fv(this.addr,!1,uu),Pt(t,n)}}function oy(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ct(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Pt(t,e)}else{if(Ct(t,n))return;hu.set(n),s.uniformMatrix3fv(this.addr,!1,hu),Pt(t,n)}}function ly(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ct(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Pt(t,e)}else{if(Ct(t,n))return;cu.set(n),s.uniformMatrix4fv(this.addr,!1,cu),Pt(t,n)}}function cy(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function hy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ct(t,e))return;s.uniform2iv(this.addr,e),Pt(t,e)}}function uy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ct(t,e))return;s.uniform3iv(this.addr,e),Pt(t,e)}}function dy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ct(t,e))return;s.uniform4iv(this.addr,e),Pt(t,e)}}function fy(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function py(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ct(t,e))return;s.uniform2uiv(this.addr,e),Pt(t,e)}}function my(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ct(t,e))return;s.uniform3uiv(this.addr,e),Pt(t,e)}}function gy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ct(t,e))return;s.uniform4uiv(this.addr,e),Pt(t,e)}}function _y(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);const r=this.type===s.SAMPLER_2D_SHADOW?Lf:Pf;t.setTexture2D(e||r,i)}function vy(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Df,i)}function yy(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Nf,i)}function xy(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||If,i)}function Ey(s){switch(s){case 5126:return ny;case 35664:return iy;case 35665:return sy;case 35666:return ry;case 35674:return ay;case 35675:return oy;case 35676:return ly;case 5124:case 35670:return cy;case 35667:case 35671:return hy;case 35668:case 35672:return uy;case 35669:case 35673:return dy;case 5125:return fy;case 36294:return py;case 36295:return my;case 36296:return gy;case 35678:case 36198:case 36298:case 36306:case 35682:return _y;case 35679:case 36299:case 36307:return vy;case 35680:case 36300:case 36308:case 36293:return yy;case 36289:case 36303:case 36311:case 36292:return xy}}function My(s,e){s.uniform1fv(this.addr,e)}function Sy(s,e){const t=Ws(e,this.size,2);s.uniform2fv(this.addr,t)}function by(s,e){const t=Ws(e,this.size,3);s.uniform3fv(this.addr,t)}function Ty(s,e){const t=Ws(e,this.size,4);s.uniform4fv(this.addr,t)}function Ay(s,e){const t=Ws(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function wy(s,e){const t=Ws(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Ry(s,e){const t=Ws(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function Cy(s,e){s.uniform1iv(this.addr,e)}function Py(s,e){s.uniform2iv(this.addr,e)}function Ly(s,e){s.uniform3iv(this.addr,e)}function Iy(s,e){s.uniform4iv(this.addr,e)}function Dy(s,e){s.uniform1uiv(this.addr,e)}function Ny(s,e){s.uniform2uiv(this.addr,e)}function Uy(s,e){s.uniform3uiv(this.addr,e)}function Fy(s,e){s.uniform4uiv(this.addr,e)}function Oy(s,e,t){const n=this.cache,i=e.length,r=to(t,i);Ct(n,r)||(s.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==i;++a)t.setTexture2D(e[a]||Pf,r[a])}function By(s,e,t){const n=this.cache,i=e.length,r=to(t,i);Ct(n,r)||(s.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||Df,r[a])}function ky(s,e,t){const n=this.cache,i=e.length,r=to(t,i);Ct(n,r)||(s.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Nf,r[a])}function Vy(s,e,t){const n=this.cache,i=e.length,r=to(t,i);Ct(n,r)||(s.uniform1iv(this.addr,r),Pt(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||If,r[a])}function zy(s){switch(s){case 5126:return My;case 35664:return Sy;case 35665:return by;case 35666:return Ty;case 35674:return Ay;case 35675:return wy;case 35676:return Ry;case 5124:case 35670:return Cy;case 35667:case 35671:return Py;case 35668:case 35672:return Ly;case 35669:case 35673:return Iy;case 5125:return Dy;case 36294:return Ny;case 36295:return Uy;case 36296:return Fy;case 35678:case 36198:case 36298:case 36306:case 35682:return Oy;case 35679:case 36299:case 36307:return By;case 35680:case 36300:case 36308:case 36293:return ky;case 36289:case 36303:case 36311:case 36292:return Vy}}class Hy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Ey(t.type)}}class Gy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=zy(t.type)}}class Wy{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,a=i.length;r!==a;++r){const o=i[r];o.setValue(e,t[o.id],n)}}}const jo=/(\w+)(\])?(\[|\.)?/g;function du(s,e){s.seq.push(e),s.map[e.id]=e}function Xy(s,e,t){const n=s.name,i=n.length;for(jo.lastIndex=0;;){const r=jo.exec(n),a=jo.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){du(t,c===void 0?new Hy(o,s,e):new Gy(o,s,e));break}else{let u=t.map[o];u===void 0&&(u=new Wy(o),du(t,u)),t=u}}}class Ca{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),a=e.getUniformLocation(t,r.name);Xy(r,a,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function fu(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const $y=37297;let qy=0;function jy(s,e){const t=s.split(`
...
`+jy(s.getShaderSource(e),a)}else return i}function Yy(s,e){const t=Ky(e);return`vec4 ${s}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Jy(s,e){let t;switch(e){case qm:t="Linear";break;case jm:t="Reinhard";break;case Km:t="OptimizedCineon";break;case rf:t="ACESFilmic";break;case Jm:t="AgX";break;case Ym:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Zy(s){return[s.extensionDerivatives||s.envMapCubeUVHeight||s.bumpMap||s.normalMapTangentSpace||s.clearcoatNormalMap||s.flatShading||s.alphaToCoverage||s.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(s.extensionFragDepth||s.logarithmicDepthBuffer)&&s.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",s.extensionDrawBuffers&&s.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(s.extensionShaderTextureLOD||s.envMap||s.transmission)&&s.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Ts).join(`
`)}function Qy(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ts).join(`
`)}function ex(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function tx(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function Ts(s){return s!==""}function mu(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function gu(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const nx=/^[ \t]*#include +<([\w\d./]+)>/gm;function Pl(s){return s.replace(nx,sx)}const ix=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function sx(s,e){let t=Oe[e];if(t===void 0){const n=ix.get(e);if(n!==void 0)t=Oe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Pl(t)}const rx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function _u(s){return s.replace(rx,ax)}function ax(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function vu(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function ox(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===sf?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Em?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Jn&&(e="SHADOWMAP_TYPE_VSM"),e}function lx(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Is:case Ds:e="ENVMAP_TYPE_CUBE";break;case Ja:e="ENVMAP_TYPE_CUBE_UV";break}return e}function cx(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ds:e="ENVMAP_MODE_REFRACTION";break}return e}function hx(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case ac:e="ENVMAP_BLENDING_MULTIPLY";break;case Xm:e="ENVMAP_BLENDING_MIX";break;case $m:e="ENVMAP_BLENDING_ADD";break}return e}function ux(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function dx(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=ox(t),c=lx(t),h=cx(t),u=hx(t),d=ux(t),f=t.isWebGL2?"":Zy(t),g=Qy(t),v=ex(r),m=i.createProgram();let p,M,y=t.glslVersion?"#version "+t.glslVersion+`
 ...
 */const pp=function(s){const e=[];let t=0;for(let n=0;n<s.length;n++){let i=s.charCodeAt(n);i<128?e[t++]=i:i<2048?(e[t++]=i>>6|192,e[t++]=i&63|128):(i&64512)===55296&&n+1<s.length&&(s.charCodeAt(n+1)&64512)===56320?(i=65536+((i&1023)<<10)+(s.charCodeAt(++n)&1023),e[t++]=i>>18|240,e[t++]=i>>12&63|128,e[t++]=i>>6&63|128,e[t++]=i&63|128):(e[t++]=i>>12|224,e[t++]=i>>6&63|128,e[t++]=i&63|128)}return e},mb=function(s){const e=[];let t=0,n=0;for(;t<s.length;){const i=s[t++];if(i<128)e[n++]=String.fromCharCode(i);else if(i>191&&i<224){const r=s[t++];e[n++]=String.fromCharCode((i&31)<<6|r&63)}else if(i>239&&i<365){const r=s[t++],a=s[t++],o=s[t++],l=((i&7)<<18|(r&63)<<12|(a&63)<<6|o&63)-65536;e[n++]=String.fromCharCode(55296+(l>>10)),e[n++]=String.fromCharCode(56320+(l&1023))}else{const r=s[t++],a=s[t++];e[n++]=String.fromCharCode((i&15)<<12|(r&63)<<6|a&63)}}return e.join("")},mp={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(s,e){if(!Array.isArray(s))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,n=[];for(let i=0;i<s.length;i+=3){const r=s[i],a=i+1<s.length,o=a?s[i+1]:0,l=i+2<s.length,c=l?s[i+2]:0,h=r>>2,u=(r&3)<<4|o>>4;let d=(o&15)<<2|c>>6,f=c&63;l||(f=64,a||(d=64)),n.push(t[h],t[u],t[d],t[f])}return n.join("")},encodeString(s,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(s):this.encodeByteArray(pp(s),e)},decodeString(s,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(s):mb(this.decodeStringToByteArray(s,e))},decodeStringToByteArray(s,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,n=[];for(let i=0;i<s.length;){const r=t[s.charAt(i++)],o=i<s.length?t[s.charAt(i)]:0;++i;const c=i<s.length?t[s.charAt(i)]:64;++i;const u=i<s.length?t[s.charAt(i)]:64;if(++i,r==null||o==null||c==null||u==null)throw new gb;const d=r<<2|o>>4;if(n.push(d),c!==64){const f=o<<4&240|c>>2;if(n.push(f),u!==64){const g=c<<6&192|u;n.push(g)}}}return n},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let s=0;s<this.ENCODED_VALS.length;s++)this.byteToCharMap_[s]=this.ENCODED_VALS.charAt(s),this.charToByteMap_[this.byteToCharMap_[s]]=s,this.byteToCharMapWebSafe_[s]=this.ENCODED_VALS_WEBSAFE.charAt(s),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[s]]=s,s>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(s)]=s,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(s)]=s)}}};class gb extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const _b=function(s){const e=pp(s);return mp.encodeByteArray(e,!0)},ka=function(s){return _b(s).replace(/\./g,"")},vb=function(s){try{return mp.decodeString(s,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xb=()=>yb().__FIREBASE_DEFAULTS__,Eb=()=>{if(typeof process>"u"||typeof yd>"u")return;const s=yd.__FIREBASE_DEFAULTS__;if(s)return JSON.parse(s)},Mb=()=>{if(typeof document>"u")return;let s;try{s=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=s&&vb(s[1]);return e&&JSON.parse(e)},gp=()=>{try{return pb()||xb()||Eb()||Mb()}catch(s){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${s}`);return}},Sb=s=>{var e,t;return(t=(e=gp())==null?void 0:e.emulatorHosts)==null?void 0:t[s]},bb=s=>{const e=Sb(s);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const n=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),n]:[e.substring(0,t),n]},_p=()=>{var s;return(s=gp())==null?void 0:s.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ab(s,e){if(s.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},n=e||"demo-project",i=s.iat||0,r=s.sub||s.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const a={iss:`https://securetoken.google.com/${n}`,aud:n,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}},...s};return[ka(JSON.stringify(t)),ka(JSON.stringify(a)),""].join(".")}function wb(){try{return typeof indexedDB=="object"}catch{return!1}}function Rb(){return new Promise((s,e)=>{try{let t=!0;const n="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(n);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(n),s(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var r;e(((r=i.error)==null?void 0:r.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cb="FirebaseError";class Ys extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name=Cb,Object.setPrototypeOf(this,Ys.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,vp.prototype.create)}}class vp{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],a=r?Pb(r,n):"Error",o=`${this.serviceName}: ${a} (${i}).`;return new Ys(i,o,n)}}function Pb(s,e){return s.replace(Lb,(t,n)=>{const i=e[n];return i!=null?String(i):`<${n}?>`})}const Lb=/\{\$([^}]+)}/g;function Va(s,e){if(s===e)return!0;const t=Object.keys(s),n=Object.keys(e);for(const i of t){if(!n.includes(i))return!1;const r=s[i],a=e[i];if(xd(r)&&xd(a)){if(!Va(r,a))return!1}else if(r!==a)return!1}for(const i of n)if(!t.includes(i))return!1;return!0}function xd(s){return s!==null&&typeof s=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var nt;(function(s){s[s.DEBUG=0]="DEBUG",s[s.VERBOSE=1]="VERBOSE",s[s.INFO=2]="INFO",s[s.WARN=3]="WARN",s[s.ERROR=4]="ERROR",s[s.SILENT=5]="SILENT"})(nt||(nt={}));const Ob={debug:nt.DEBUG,verbose:nt.VERBOSE,info:nt.INFO,warn:nt.WARN,error:nt.ERROR,silent:nt.SILENT},Bb=nt.INFO,kb={[nt.DEBUG]:"log",[nt.VERBOSE]:"log",[nt.INFO]:"info",[nt.WARN]:"warn",[nt.ERROR]:"error"},Vb=(s,e,...t)=>{if(e<s.logLevel)return;const n=new Date().toISOString(),i=kb[e];if(i)console[i](`[${n}]  ${s.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class xp{constructor(e){this.name=e,this._logLevel=Bb,this._logHandler=Vb,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in nt))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Ob[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,nt.DEBUG,...e),this._logHandler(this,nt.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,nt.VERBOSE,...e),this._logHandler(this,nt.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,nt.INFO,...e),this._logHandler(this,nt.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,nt.WARN,...e),this._logHandler(this,nt.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,nt.ERROR,...e),this._logHandler(this,nt.ERROR,...e)}}const zb=(s,e)=>e.some(t=>s instanceof t);let Ed,Md;function Hb(){return Ed||(Ed=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Gb(){return Md||(Md=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Ep=new WeakMap,ql=new WeakMap,Mp=new WeakMap,ml=new WeakMap,Ic=new WeakMap;function Wb(s){const e=new Promise((t,n)=>{const i=()=>{s.removeEventListener("success",r),s.removeEventListener("error",a)},r=()=>{t(Si(s.result)),i()},a=()=>{n(s.error),i()};s.addEventListener("success",r),s.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&Ep.set(t,s)}).catch(()=>{}),Ic.set(e,s),e}function Xb(s){if(ql.has(s))return;const e=new Promise((t,n)=>{const i=()=>{s.removeEventListener("complete",r),s.removeEventListener("error",a),s.removeEventListener("abort",a)},r=()=>{t(),i()},a=()=>{n(s.error||new DOMException("AbortError","AbortError")),i()};s.addEventListener("complete",r),s.addEventListener("error",a),s.addEventListener("abort",a)});ql.set(s,e)}let jl={get(s,e,t){if(s instanceof IDBTransaction){if(e==="done")return ql.get(s);if(e==="objectStoreNames")return s.objectStoreNames||Mp.get(s);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Si(s[e])},set(s,e,t){return s[e]=t,!0},has(s,e){return s instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in s}};function $b(s){jl=s(jl)}function qb(s){return s===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const n=s.call(gl(this),e,...t);return Mp.set(n,e.sort?e.sort():[e]),Si(n)}:Gb().includes(s)?function(...e){return s.apply(gl(this),e),Si(Ep.get(this))}:function(...e){return Si(s.apply(gl(this),e))}}function jb(s){return typeof s=="function"?qb(s):(s instanceof IDBTransaction&&Xb(s),zb(s,Hb())?new Proxy(s,jl):s)}function Si(s){if(s instanceof IDBRequest)return Wb(s);if(ml.has(s))return ml.get(s);const e=jb(s);return e!==s&&(ml.set(s,e),Ic.set(e,s)),e}const gl=s=>Ic.get(s);function Kb(s,e,{blocked:t,upgrade:n,blocking:i,terminated:r}={}){const a=indexedDB.open(s,e),o=Si(a);return n&&a.addEventListener("upgradeneeded",l=>{n(Si(a.result),l.oldVersion,l.newVersion,Si(a.transaction),l)}),t&&a.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),o.then(l=>{r&&l.addEventListener("close",()=>r()),i&&l.addEventListener("versionchange",c=>i(c.oldVersion,c.newVersion,c))}).catch(()=>{}),o}const Yb=["get","getKey","getAll","getAllKeys","count"],Jb=["put","add","delete","clear"],_l=new Map;function Sd(s,e){if(!(s instanceof IDBDatabase&&!(e in s)&&typeof e=="string"))return;if(_l.get(e))return _l.get(e);const t=e.replace(/FromIndex$/,""),n=e!==t,i=Jb.includes(t);if(!(t in(n?IDBIndex:IDBObjectStore).prototype)||!(i||Yb.includes(t)))return;const r=async function(a,...o){const l=this.transaction(a,i?"readwrite":"readonly");let c=l.store;return n&&(c=c.index(o.shift())),(await Promise.all([c[t](...o),i&&l.done]))[0]};return _l.set(e,r),r}$b(s=>({...s,get:(e,t,n)=>Sd(e,t)||s.get(e,t,n),has:(e,t)=>!!Sd(e,t)||s.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zb{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Qb(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function Qb(s){const e=s.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Kl="@firebase/app",bd="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const si=new xp("@firebase/app"),eT="@firebase/app-compat",tT="@firebase/analytics-compat",nT="@firebase/analytics",iT="@firebase/app-check-compat",sT="@firebase/app-check",rT="@firebase/auth",aT="@firebase/auth-compat",oT="@firebase/database",lT="@firebase/data-connect",cT="@firebase/database-compat",hT="@firebase/functions",uT="@firebase/functions-compat",dT="@firebase/installations",fT="@firebase/installations-compat",pT="@firebase/messaging",mT="@firebase/messaging-compat",gT="@firebase/performance",_T="@firebase/performance-compat",vT="@firebase/remote-config",yT="@firebase/remote-config-compat",xT="@firebase/storage",ET="@firebase/storage-compat",MT="@firebase/firestore",ST="@firebase/ai",bT="@firebase/firestore-compat",TT="firebase",AT="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yl="[DEFAULT]",wT={[Kl]:"fire-core",[eT]:"fire-core-compat",[nT]:"fire-analytics",[tT]:"fire-analytics-compat",[sT]:"fire-app-check",[iT]:"fire-app-check-compat",[rT]:"fire-auth",[aT]:"fire-auth-compat",[oT]:"fire-rtdb",[lT]:"fire-data-connect",[cT]:"fire-rtdb-compat",[hT]:"fire-fn",[uT]:"fire-fn-compat",[dT]:"fire-iid",[fT]:"fire-iid-compat",[pT]:"fire-fcm",[mT]:"fire-fcm-compat",[gT]:"fire-perf",[_T]:"fire-perf-compat",[vT]:"fire-rc",[yT]:"fire-rc-compat",[xT]:"fire-gcs",[ET]:"fire-gcs-compat",[MT]:"fire-fst",[bT]:"fire-fst-compat",[ST]:"fire-vertex","fire-js":"fire-js",[TT]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const za=new Map,RT=new Map,Jl=new Map;function Td(s,e){try{s.container.addComponent(e)}catch(t){si.debug(`Component ${e.name} failed to register with FirebaseApp ${s.name}`,t)}}function Ha(s){const e=s.name;if(Jl.has(e))return si.debug(`There were multiple attempts to register component ${e}.`),!1;Jl.set(e,s);for(const t of za.values())Td(t,s);for(const t of RT.values())Td(t,s);return!0}function CT(s,e){const t=s.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),s.container.getProvider(e)}function PT(s){return s==null?!1:s.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DT=AT;function Sp(s,e={}){let t=s;typeof e!="object"&&(e={name:e});const n={name:Yl,automaticDataCollectionEnabled:!0,...e},i=n.name;if(typeof i!="string"||!i)throw bi.create("bad-app-name",{appName:String(i)});if(t||(t=_p()),!t)throw bi.create("no-options");const r=za.get(i);if(r){if(Va(t,r.options)&&Va(n,r.config))return r;throw bi.create("duplicate-app",{appName:i})}const a=new Fb(i);for(const l of Jl.values())a.addComponent(l);const o=new IT(t,n,a);return za.set(i,o),o}function NT(s=Yl){const e=za.get(s);if(!e&&s===Yl&&_p())return Sp();if(!e)throw bi.create("no-app",{appName:s});return e}function Ls(s,e,t){let n=wT[s]??s;t&&(n+=`-${t}`);const i=n.match(/\s|\//),r=e.match(/\s|\//);if(i||r){const a=[`Unable to register library "${n}" with version "${e}":`];i&&a.push(`library name "${n}" contains illegal characters (whitespace or "/")`),i&&r&&a.push("and"),r&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),si.warn(a.join(" "));return}Ha(new Ir(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const UT="firebase-heartbeat-database",FT=1,Dr="firebase-heartbeat-store";let vl=null;function bp(){return vl||(vl=Kb(UT,FT,{upgrade:(s,e)=>{switch(e){case 0:try{s.createObjectStore(Dr)}catch(t){console.warn(t)}}}}).catch(s=>{throw bi.create("idb-open",{originalErrorMessage:s.message})})),vl}async function OT(s){try{const t=(await bp()).transaction(Dr),n=await t.objectStore(Dr).get(Tp(s));return await t.done,n}catch(e){if(e instanceof Ys)si.warn(e.message);else{const t=bi.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});si.warn(t.message)}}}async function Ad(s,e){try{const n=(await bp()).transaction(Dr,"readwrite");await n.objectStore(Dr).put(e,Tp(s)),await n.done}catch(t){if(t instanceof Ys)si.warn(t.message);else{const n=bi.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});si.warn(n.message)}}}function Tp(s){return`${s.name}!${s.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BT=1024,kT=30;class VT{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new HT(t),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=wd();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(a=>a.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:i}),this._heartbeatsCache.heartbeats.length>kT){const a=GT(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){si.warn(n)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=wd(),{heartbeatsToSend:n,unsentEntries:i}=zT(this._heartbeatsCache.heartbeats),r=ka(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(t){return si.warn(t),""}}}function wd(){return new Date().toISOString().substring(0,10)}function zT(s,e=BT){const t=[];let n=s.slice();for(const i of s){const r=t.find(a=>a.agent===i.agent);if(r){if(r.dates.push(i.date),Rd(t)>e){r.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),Rd(t)>e){t.pop();break}n=n.slice(1)}return{heartbeatsToSend:t,unsentEntries:n}}class HT{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return wb()?Rb().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await OT(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const n=await this.read();return Ad(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const n=await this.read();return Ad(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}else return}}function Rd(s){return ka(JSON.stringify({version:2,heartbeats:s})).length}function GT(s){if(s.length===0)return-1;let e=0,t=s[0].date;for(let n=1;n<s.length;n++)s[n].date<t&&(t=s[n].date,e=n);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Js="12.13.0";function XT(s){Js=s}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hs=new xp("@firebase/firestore");function Ga(s,...e){if(Hs.logLevel<=nt.DEBUG){const t=e.map(Nc);Hs.debug(`Firestore (${Js}): ${s}`,...t)}}function Dc(s,...e){if(Hs.logLevel<=nt.ERROR){const t=e.map(Nc);Hs.error(`Firestore (${Js}): ${s}`,...t)}}function wp(s,...e){if(Hs.logLevel<=nt.WARN){const t=e.map(Nc);Hs.warn(`Firestore (${Js}): ${s}`,...t)}}function Nc(s){if(typeof s=="string")return s;try{return function(t){return JSON.stringify(t)}(s)}catch{return s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cp{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class $T{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(nn.UNAUTHENTICATED))}shutdown(){}}class qT{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class jT{constructor(e){this.auth=null,e.onInit(t=>{this.auth=t})}getToken(){return this.auth?this.auth.getToken().then(e=>e?(un(typeof e.accessToken=="string",42297,{t:e}),new Cp(e.accessToken,new nn(this.auth.getUid()))):null):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}class KT{constructor(e,t,n){this.i=e,this.o=t,this.u=n,this.type="FirstParty",this.user=nn.FIRST_PARTY,this.l=new Map}h(){return this.u?this.u():null}get headers(){this.l.set("X-Goog-AuthUser",this.i);const e=this.h();return e&&this.l.set("Authorization",e),this.o&&this.l.set("X-Goog-Iam-Authorization-Token",this.o),this.l}}class YT{constructor(e,t,n){this.i=e,this.o=t,this.u=n}getToken(){return Promise.resolve(new KT(this.i,this.o,this.u))}start(e,t){e.enqueueRetryable(()=>t(nn.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Pd{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class JT{constructor(e,t){this.m=t,this.appCheck=null,this.P=null,PT(e)&&e.settings.appCheckToken&&(this.P=e.settings.appCheckToken),t.onInit(n=>{this.appCheck=n})}getToken(){return this.P?Promise.resolve(new Pd(this.P)):this.appCheck?this.appCheck.getToken().then(e=>e?(un(typeof e.token=="string",3470,{tokenResult:e}),new Pd(e.token)):null):Promise.resolve(null)}invalidateToken(){}start(e,t){}shutdown(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eA(s){const e=typeof self<"u"&&(self.crypto||self.msCrypto),t=new Uint8Array(s);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(t);else for(let n=0;n<s;n++)t[n]=Math.floor(256*Math.random());return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tA{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const i=eA(40);for(let r=0;r<i.length;++r)n.length<20&&i[r]<t&&(n+=e.charAt(i[r]%62))}return n}}function bt(s,e){return s<e?-1:s>e?1:0}function Ql(s,e){const t=Math.min(s.length,e.length);for(let n=0;n<t;n++){const i=s.charAt(n),r=e.charAt(n);if(i!==r)return yl(i)===yl(r)?bt(i,r):yl(i)?1:-1}return bt(s.length,e.length)}const nA=55296,iA=57343;function yl(s){const e=s.charCodeAt(0);return e>=nA&&e<=iA}function Pp(s,e,t){return s.length===e.length&&s.every((n,i)=>t(n,e[i]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dp(s){const e={};return s.timeoutSeconds!==void 0&&(e.timeoutSeconds=s.timeoutSeconds),e}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ta=null;function rA(){return Ta===null?Ta=function(){return 268435456+Math.round(2147483648*Math.random())}():Ta++,"0x"+Ta.toString(16)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aA(s){return s==null}function Wa(s){return s===0&&1/s==-1/0}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xl="RestConnection",oA={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class lA{get T(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.R=t+"://"+e.host,this.V=`projects/${n}/databases/${i}`,this.A=this.databaseId.database===Zl?`project_id=${n}`:`project_id=${n}&database_id=${i}`}I(e,t,n,i,r){const a=rA(),o=this.p(e,t.toUriEncodedString());Ga(xl,`Sending RPC '${e}' ${a}:`,o,n);const l={"google-cloud-resource-prefix":this.V,"x-goog-request-params":this.A};this.F(l,i,r);const{host:c}=new URL(o),h=yp(c);return this.v(e,o,l,n,h).then(u=>(Ga(xl,`Received RPC '${e}' ${a}: `,u),u),u=>{throw wp(xl,`RPC '${e}' ${a} failed with error: `,u,"url: ",o,"request:",n),u})}D(e,t,n,i,r,a){return this.I(e,t,n,i,r)}F(e,t,n){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Js}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((i,r)=>e[r]=i),n&&n.headers.forEach((i,r)=>e[r]=i)}p(e,t){const n=oA[e];let i=`${this.R}/v1/${t}:${n}`;return this.databaseInfo.apiKey&&(i=`${i}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),i}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(qe=Nd||(Nd={}))[qe.OK=0]="OK",qe[qe.CANCELLED=1]="CANCELLED",qe[qe.UNKNOWN=2]="UNKNOWN",qe[qe.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",qe[qe.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",qe[qe.NOT_FOUND=5]="NOT_FOUND",qe[qe.ALREADY_EXISTS=6]="ALREADY_EXISTS",qe[qe.PERMISSION_DENIED=7]="PERMISSION_DENIED",qe[qe.UNAUTHENTICATED=16]="UNAUTHENTICATED",qe[qe.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",qe[qe.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",qe[qe.ABORTED=10]="ABORTED",qe[qe.OUT_OF_RANGE=11]="OUT_OF_RANGE",qe[qe.UNIMPLEMENTED=12]="UNIMPLEMENTED",qe[qe.INTERNAL=13]="INTERNAL",qe[qe.UNAVAILABLE=14]="UNAVAILABLE",qe[qe.DATA_LOSS=15]="DATA_LOSS";class cA extends lA{S(e,t){throw new Error("Not supported by FetchConnection")}async v(e,t,n,i,r){var l;const a=JSON.stringify(i);let o;try{const c={method:"POST",headers:n,body:a};r&&(c.credentials="include"),o=await fetch(t,c)}catch(c){const h=c;throw new ge(Ud(h.status),"Request failed with error: "+h.statusText)}if(!o.ok){let c=await o.json();Array.isArray(c)&&(c=c[0]);const h=(l=c==null?void 0:c.error)==null?void 0:l.message;throw new ge(Ud(o.status),`Request failed with error: ${h??o.statusText}`)}return o.json()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fd(s){let e=0;for(const t in s)Object.prototype.hasOwnProperty.call(s,t)&&e++;return e}function ho(s,e){for(const t in s)Object.prototype.hasOwnProperty.call(s,t)&&e(t,s[t])}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ri{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(i){try{return atob(i)}catch(r){throw typeof DOMException<"u"&&r instanceof DOMException?new hA("Invalid base64 string: "+r):r}}(e);return new ri(t)}static fromUint8Array(e){const t=function(i){let r="";for(let a=0;a<i.length;++a)r+=String.fromCharCode(i[a]);return r}(e);return new ri(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const n=new Uint8Array(t.length);for(let i=0;i<t.length;i++)n[i]=t.charCodeAt(i);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return bt(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}ri.EMPTY_BYTE_STRING=new ri("");const uA=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Yi(s){if(un(!!s,39018),typeof s=="string"){let e=0;const t=uA.exec(s);if(un(!!t,46558,{timestamp:s}),t[1]){let i=t[1];i=(i+"000000000").substr(0,9),e=Number(i)}const n=new Date(s);return{seconds:Math.floor(n.getTime()/1e3),nanos:e}}return{seconds:Tt(s.seconds),nanos:Tt(s.nanos)}}function Tt(s){return typeof s=="number"?s:typeof s=="string"?Number(s):0}function Ur(s){return typeof s=="string"?ri.fromBase64String(s):ri.fromUint8Array(s)}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function En(s,e){const t={typeString:s};return e&&(t.value=e),t}function Wr(s,e){if(!Ip(s))throw new ge(re.INVALID_ARGUMENT,"JSON must be an object");let t;for(const n in e)if(e[n]){const i=e[n].typeString,r="value"in e[n]?{value:e[n].value}:void 0;if(!(n in s)){t=`JSON missing required field: '${n}'`;break}const a=s[n];if(i&&typeof a!==i){t=`JSON field '${n}' must be a ${i}.`;break}if(r!==void 0&&a!==r.value){t=`Expected '${n}' field to equal '${r.value}'`;break}}if(t)throw new ge(re.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fp="__type__",dA="__max__",Aa={},Op="__vector__",Xa="value";function Ji(s){return"nullValue"in s?0:"booleanValue"in s?1:"integerValue"in s||"doubleValue"in s?2:"timestampValue"in s?3:"stringValue"in s?5:"bytesValue"in s?6:"referenceValue"in s?7:"geoPointValue"in s?8:"arrayValue"in s?9:"mapValue"in s?Np(s)?4:function(t){return(((t.mapValue||{}).fields||{}).__type__||{}).stringValue===dA}(s)?9007199254740991:function(t){var i,r;return((r=(((i=t==null?void 0:t.mapValue)==null?void 0:i.fields)||{})[Fp])==null?void 0:r.stringValue)===Op}(s)?10:11:yt(28295,{value:s})}function $a(s,e){if(s===e)return!0;const t=Ji(s);if(t!==Ji(e))return!1;switch(t){case 0:case 9007199254740991:return!0;case 1:return s.booleanValue===e.booleanValue;case 4:return Fr(s).isEqual(Fr(e));case 3:return function(i,r){if(typeof i.timestampValue=="string"&&typeof r.timestampValue=="string"&&i.timestampValue.length===r.timestampValue.length)return i.timestampValue===r.timestampValue;const a=Yi(i.timestampValue),o=Yi(r.timestampValue);return a.seconds===o.seconds&&a.nanos===o.nanos}(s,e);case 5:return s.stringValue===e.stringValue;case 6:return function(i,r){return Ur(i.bytesValue).isEqual(Ur(r.bytesValue))}(s,e);case 7:return s.referenceValue===e.referenceValue;case 8:return function(i,r){return Tt(i.geoPointValue.latitude)===Tt(r.geoPointValue.latitude)&&Tt(i.geoPointValue.longitude)===Tt(r.geoPointValue.longitude)}(s,e);case 2:return function(i,r){if("integerValue"in i&&"integerValue"in r)return Tt(i.integerValue)===Tt(r.integerValue);if("doubleValue"in i&&"doubleValue"in r){const a=Tt(i.doubleValue),o=Tt(r.doubleValue);return a===o?Wa(a)===Wa(o):isNaN(a)&&isNaN(o)}return!1}(s,e);case 9:return Pp(s.arrayValue.values||[],e.arrayValue.values||[],$a);case 10:case 11:return function(i,r){const a=i.mapValue.fields||{},o=r.mapValue.fields||{};if(Fd(a)!==Fd(o))return!1;for(const l in a)if(a.hasOwnProperty(l)&&(o[l]===void 0||!$a(a[l],o[l])))return!1;return!0}(s,e);default:return yt(52216,{left:s})}}function Or(s,e){return(s.values||[]).find(t=>$a(t,e))!==void 0}function qa(s,e){if(s===e)return 0;const t=Ji(s),n=Ji(e);if(t!==n)return bt(t,n);switch(t){case 0:case 9007199254740991:return 0;case 1:return bt(s.booleanValue,e.booleanValue);case 2:return function(r,a){const o=Tt(r.integerValue||r.doubleValue),l=Tt(a.integerValue||a.doubleValue);return o<l?-1:o>l?1:o===l?0:isNaN(o)?isNaN(l)?0:-1:1}(s,e);case 3:return kd(s.timestampValue,e.timestampValue);case 4:return kd(Fr(s),Fr(e));case 5:return Ql(s.stringValue,e.stringValue);case 6:return function(r,a){const o=Ur(r),l=Ur(a);return o.compareTo(l)}(s.bytesValue,e.bytesValue);case 7:return function(r,a){const o=r.split("/"),l=a.split("/");for(let c=0;c<o.length&&c<l.length;c++){const h=bt(o[c],l[c]);if(h!==0)return h}return bt(o.length,l.length)}(s.referenceValue,e.referenceValue);case 8:return function(r,a){const o=bt(Tt(r.latitude),Tt(a.latitude));return o!==0?o:bt(Tt(r.longitude),Tt(a.longitude))}(s.geoPointValue,e.geoPointValue);case 9:return Vd(s.arrayValue,e.arrayValue);case 10:return function(r,a){var d,f,g,v;const o=r.fields||{},l=a.fields||{},c=(d=o[Xa])==null?void 0:d.arrayValue,h=(f=l[Xa])==null?void 0:f.arrayValue,u=bt(((g=c==null?void 0:c.values)==null?void 0:g.length)||0,((v=h==null?void 0:h.values)==null?void 0:v.length)||0);return u!==0?u:Vd(c,h)}(s.mapValue,e.mapValue);case 11:return function(r,a){if(r===Aa&&a===Aa)return 0;if(r===Aa)return 1;if(a===Aa)return-1;const o=r.fields||{},l=Object.keys(o),c=a.fields||{},h=Object.keys(c);l.sort(),h.sort();for(let u=0;u<l.length&&u<h.length;++u){const d=Ql(l[u],h[u]);if(d!==0)return d;const f=qa(o[l[u]],c[h[u]]);if(f!==0)return f}return bt(l.length,h.length)}(s.mapValue,e.mapValue);default:throw yt(23264,{C:t})}}function kd(s,e){if(typeof s=="string"&&typeof e=="string"&&s.length===e.length)return bt(s,e);const t=Yi(s),n=Yi(e),i=bt(t.seconds,n.seconds);return i!==0?i:bt(t.nanos,n.nanos)}function Vd(s,e){const t=s.values||[],n=e.values||[];for(let i=0;i<t.length&&i<n.length;++i){const r=qa(t[i],n[i]);if(r)return r}return bt(t.length,n.length)}function zd(s,e){return{referenceValue:`projects/${s.projectId}/databases/${s.database}/documents/${e.path.canonicalString()}`}}function Bp(s){return!!s&&"arrayValue"in s}function Hd(s){return!!s&&"nullValue"in s}function Gd(s){return!!s&&"doubleValue"in s&&isNaN(Number(s.doubleValue))}function El(s){return!!s&&"mapValue"in s}function Er(s){if(s.geoPointValue)return{geoPointValue:{...s.geoPointValue}};if(s.timestampValue&&typeof s.timestampValue=="object")return{timestampValue:{...s.timestampValue}};if(s.mapValue){const e={mapValue:{fields:{}}};return ho(s.mapValue.fields,(t,n)=>e.mapValue.fields[t]=Er(n)),e}if(s.arrayValue){const e={arrayValue:{values:[]}};for(let t=0;t<(s.arrayValue.values||[]).length;++t)e.arrayValue.values[t]=Er(s.arrayValue.values[t]);return e}return{...s}}class Wd{constructor(e,t){this.position=e,this.inclusive=t}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kp{}class Ln extends kp{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}static create(e,t,n){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,n):new fA(e,t,n):t==="array-contains"?new gA(e,n):t==="in"?new _A(e,n):t==="not-in"?new vA(e,n):t==="array-contains-any"?new yA(e,n):new Ln(e,t,n)}static createKeyFieldInFilter(e,t,n){return t==="in"?new pA(e,n):new mA(e,n)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(qa(t,this.value)):t!==null&&Ji(this.value)===Ji(t)&&this.matchesComparison(qa(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return yt(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Xr extends kp{constructor(e,t){super(),this.filters=e,this.op=t,this.N=null}static create(e,t){return new Xr(e,t)}matches(e){return function(n){return n.op==="and"}(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.N!==null||(this.N=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.N}getFilters(){return Object.assign([],this.filters)}}class fA extends Ln{constructor(e,t,n){super(e,t,n),this.key=Ot.fromName(n.referenceValue)}matches(e){const t=Ot.comparator(e.key,this.key);return this.matchesComparison(t)}}class pA extends Ln{constructor(e,t){super(e,"in",t),this.keys=Vp("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class mA extends Ln{constructor(e,t){super(e,"not-in",t),this.keys=Vp("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Vp(s,e){var t;return(((t=e.arrayValue)==null?void 0:t.values)||[]).map(n=>Ot.fromName(n.referenceValue))}class gA extends Ln{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Bp(t)&&Or(t.arrayValue,this.value)}}class _A extends Ln{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&Or(this.value.arrayValue,t)}}class vA extends Ln{constructor(e,t){super(e,"not-in",t)}matches(e){if(Or(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!Or(this.value.arrayValue,t)}}class yA extends Ln{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Bp(t)||!t.arrayValue.values)&&t.arrayValue.values.some(n=>Or(this.value.arrayValue,n))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xA{constructor(e,t=null,n=[],i=[],r=null,a=null,o=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=i,this.limit=r,this.startAt=a,this.endAt=o,this.O=null}}function $d(s,e=null,t=[],n=[],i=null,r=null,a=null){return new xA(s,e,t,n,i,r,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zp{constructor(e,t=null,n=[],i=[],r=null,a="F",o=null,l=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=i,this.limit=r,this.limitType=a,this.startAt=o,this.endAt=l,this.q=null,this.L=null,this.B=null,this.startAt,this.endAt}}function EA(s){return s.collectionGroup!==null}function MA(s){const e=Gr(s);if(e.q===null){e.q=[];const t=new Set;for(const r of e.explicitOrderBy)e.q.push(r),t.add(r.field.canonicalString());const n=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(a){let o=new Br(sn.comparator);return a.filters.forEach(l=>{l.getFlattenedFilters().forEach(c=>{c.isInequality()&&(o=o.add(c.field))})}),o})(e).forEach(r=>{t.has(r.canonicalString())||r.isKeyField()||e.q.push(new ec(r,n))}),t.has(sn.keyField().canonicalString())||e.q.push(new ec(sn.keyField(),n))}return e.q}function SA(s){const e=Gr(s);return e.L||(e.L=bA(e,MA(s))),e.L}function bA(s,e){if(s.limitType==="F")return $d(s.path,s.collectionGroup,e,s.filters,s.limit,s.startAt,s.endAt);{e=e.map(i=>{const r=i.dir==="desc"?"asc":"desc";return new ec(i.field,r)});const t=s.endAt?new Wd(s.endAt.position,s.endAt.inclusive):null,n=s.startAt?new Wd(s.startAt.position,s.startAt.inclusive):null;return $d(s.path,s.collectionGroup,e,s.filters,s.limit,t,n)}}function tc(s,e){const t=s.filters.concat([e]);return new zp(s.path,s.collectionGroup,s.explicitOrderBy.slice(),t,s.limit,s.limitType,s.startAt,s.endAt)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hp(s,e){if(s.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Wa(e)?"-0":e}}function TA(s,e){return function(n){return typeof n=="number"&&Number.isInteger(n)&&!Wa(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}(e)?function(n){return{integerValue:""+n}}(e):Hp(s,e)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uo{constructor(){this._=void 0}}class Gp extends uo{}class AA extends uo{constructor(e){super(),this.elements=e}}class wA extends uo{constructor(e){super(),this.elements=e}}class RA extends uo{constructor(e,t){super(),this.serializer=e,this.$=t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IA={asc:"ASCENDING",desc:"DESCENDING"},DA={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},NA={and:"AND",or:"OR"};class UA{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function nc(s,e){return s.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function FA(s,e){return s.useProto3Json?e.toBase64():e.toUint8Array()}function OA(s,e){return nc(s,e.toTimestamp())}function Sr(s){return un(!!s,49232),Gt.fromTimestamp(function(t){const n=Yi(t);return new wt(n.seconds,n.nanos)}(s))}function Uc(s,e){return ic(s,e).canonicalString()}function ic(s,e){const t=function(i){return new Et(["projects",i.projectId,"databases",i.database])}(s).child("documents");return e===void 0?t:t.child(e)}function Ka(s,e){return Uc(s.databaseId,e.path)}function sc(s,e){const t=function(i){const r=Et.fromString(i);return un(qp(r),10190,{key:r.toString()}),r}(e);if(t.get(1)!==s.databaseId.projectId)throw new ge(re.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+s.databaseId.projectId);if(t.get(3)!==s.databaseId.database)throw new ge(re.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+s.databaseId.database);return new Ot(function(i){return un(i.length>4&&i.get(4)==="documents",29091,{key:i.toString()}),i.popFirst(5)}(t))}function qd(s,e,t){return{name:Ka(s,e),fields:t.value.mapValue.fields}}function BA(s,e){return"found"in e?function(n,i){un(!!i.found,43571),i.found.name,i.found.updateTime;const r=sc(n,i.found.name),a=Sr(i.found.updateTime),o=i.found.createTime?Sr(i.found.createTime):Gt.min(),l=new Rn({mapValue:{fields:i.found.fields}});return On.newFoundDocument(r,a,o,l)}(s,e):"missing"in e?function(n,i){un(!!i.missing,3894),un(!!i.readTime,22933);const r=sc(n,i.missing),a=Sr(i.readTime);return On.newNoDocument(r,a)}(s,e):yt(7234,{result:e})}function kA(s,e){let t;if(e instanceof Wp)t={update:qd(s,e.key,e.value)};else if(e instanceof PA)t={delete:Ka(s,e.key)};else if(e instanceof Xp)t={update:qd(s,e.key,e.data),updateMask:WA(e.fieldMask)};else{if(!(e instanceof LA))return yt(16599,{U:e.type});t={verify:Ka(s,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(n=>function(r,a){const o=a.transform;if(o instanceof Gp)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(o instanceof AA)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:o.elements}};if(o instanceof wA)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:o.elements}};if(o instanceof RA)return{fieldPath:a.field.canonicalString(),increment:o.$};throw yt(20930,{transform:a.transform})}(0,n))),e.precondition.isNone||(t.currentDocument=function(i,r){return r.updateTime!==void 0?{updateTime:OA(i,r.updateTime)}:r.exists!==void 0?{exists:r.exists}:yt(27497)}(s,e.precondition)),t}function VA(s,e){const t={structuredQuery:{}},n=e.path;let i;e.collectionGroup!==null?(i=n,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(i=n.popLast(),t.structuredQuery.from=[{collectionId:n.lastSegment()}]),t.parent=function(c,h){return Uc(c.databaseId,h)}(s,i);const r=function(c){if(c.length!==0)return $p(Xr.create(c,"and"))}(e.filters);r&&(t.structuredQuery.where=r);const a=function(c){if(c.length!==0)return c.map(h=>function(d){return{field:Ss(d.field),direction:zA(d.dir)}}(h))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const o=function(c,h){return c.useProto3Json||aA(h)?h:{value:h}}(s,e.limit);return o!==null&&(t.structuredQuery.limit=o),e.startAt&&(t.structuredQuery.startAt=function(c){return{before:c.inclusive,values:c.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(c){return{before:!c.inclusive,values:c.position}}(e.endAt)),{M:t,parent:i}}function zA(s){return IA[s]}function HA(s){return DA[s]}function GA(s){return NA[s]}function Ss(s){return{fieldPath:s.canonicalString()}}function $p(s){return s instanceof Ln?function(t){if(t.op==="=="){if(Gd(t.value))return{unaryFilter:{field:Ss(t.field),op:"IS_NAN"}};if(Hd(t.value))return{unaryFilter:{field:Ss(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Gd(t.value))return{unaryFilter:{field:Ss(t.field),op:"IS_NOT_NAN"}};if(Hd(t.value))return{unaryFilter:{field:Ss(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Ss(t.field),op:HA(t.op),value:t.value}}}(s):s instanceof Xr?function(t){const n=t.getFilters().map(i=>$p(i));return n.length===1?n[0]:{compositeFilter:{op:GA(t.op),filters:n}}}(s):yt(54877,{filter:s})}function WA(s){const e=[];return s.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function qp(s){return s.length>=4&&s.get(0)==="projects"&&s.get(2)==="databases"}function jp(s){return!!s&&typeof s._toProto=="function"&&s._protoValueType==="ProtoValue"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fc(s){return new UA(s,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kp="ComponentProvider",br=new Map;function Oc(s){if(s._terminated)throw new ge(re.FAILED_PRECONDITION,"The client has already been terminated.");if(!br.has(s)){Ga(Kp,"Initializing Datastore");const e=function(r){return new cA(r)}(function(r,a,o,l,c){return new ZT(r,a,o,c.host,c.ssl,c.experimentalForceLongPolling,c.experimentalAutoDetectLongPolling,Dp(c.experimentalLongPollingOptions),c.useFetchStreams,c.isUsingEmulator,l)}(s._databaseId,s.app.options.appId||"",s._persistenceKey,s.app.options.apiKey,s._freezeSettings())),t=Fc(s._databaseId),n=function(r,a,o,l){return new $A(r,a,o,l)}(s._authCredentials,s._appCheckCredentials,e,t);br.set(s,n)}return br.get(s)}const YA=1048576,Yp="firestore.googleapis.com",jd=!0;class Kd{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new ge(re.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Yp,this.ssl=jd}else this.host=e.host,this.ssl=e.ssl??jd;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<YA)throw new ge(re.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}(function(n,i,r,a){if(i===!0&&a===!0)throw new ge(re.INVALID_ARGUMENT,`${n} and ${r} cannot be used together.`)})("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Dp(e.experimentalLongPollingOptions??{}),function(n){if(n.timeoutSeconds!==void 0){if(isNaN(n.timeoutSeconds))throw new ge(re.INVALID_ARGUMENT,`invalid long polling timeout: ${n.timeoutSeconds} (must not be NaN)`);if(n.timeoutSeconds<5)throw new ge(re.INVALID_ARGUMENT,`invalid long polling timeout: ${n.timeoutSeconds} (minimum allowed value is 5)`);if(n.timeoutSeconds>30)throw new ge(re.INVALID_ARGUMENT,`invalid long polling timeout: ${n.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(n,i){return n.timeoutSeconds===i.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class po{constructor(e,t,n,i){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=n,this._app=i,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Kd({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new ge(re.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new ge(re.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Kd(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=function(n){if(!n)return new $T;switch(n.type){case"firstParty":return new YT(n.sessionIndex||"0",n.iamToken||null,n.authTokenFactory||null);case"provider":return n.client;default:throw new ge(re.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const n=br.get(t);n&&(Ga(Kp,"Removing Datastore"),br.delete(t),n.terminate())}(this),Promise.resolve()}}function JA(s,e){const t=typeof s=="object"?s:NT(),n=typeof s=="string"?s:"(default)",i=CT(t,"firestore/lite").getImmediate({identifier:n});if(!i._initialized){const r=bb("firestore");r&&ZA(i,...r)}return i}function ZA(s,e,t,n={}){var c;s=co(s,po);const i=yp(e),r=s._getSettings(),a={...r,emulatorOptions:s._getEmulatorOptions()},o=`${e}:${t}`;i&&Ib(`https://${o}`),r.host!==Yp&&r.host!==o&&wp("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const l={...r,host:o,ssl:i,emulatorOptions:n};if(!Va(l,a)&&(s._setSettings(l),n.mockUserToken)){let h,u;if(typeof n.mockUserToken=="string")h=n.mockUserToken,u=nn.MOCK_USER;else{h=Ab(n.mockUserToken,(c=s._app)==null?void 0:c.options.projectId);const d=n.mockUserToken.sub||n.mockUserToken.user_id;if(!d)throw new ge(re.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");u=new nn(d)}s._authCredentials=new qT(new Cp(h,u))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zp{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new ge(re.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new sn(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ew=/^__.*__$/;class tw{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return this.fieldMask!==null?new Xp(e,this.data,this.fieldMask,t,this.fieldTransforms):new Wp(e,this.data,t,this.fieldTransforms)}}function Qp(s){switch(s){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw yt(40011,{dataSource:s})}}class kc{constructor(e,t,n,i,r,a){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=i,r===void 0&&this.G(),this.fieldTransforms=r||[],this.fieldMask=a||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}ne(e){return new kc({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}J(e){var i;const t=(i=this.path)==null?void 0:i.child(e),n=this.ne({path:t,arrayElement:!1});return n.H(e),n}Y(e){var i;const t=(i=this.path)==null?void 0:i.child(e),n=this.ne({path:t,arrayElement:!1});return n.G(),n}X(e){return this.ne({path:void 0,arrayElement:!0})}Z(e){return Ya(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}G(){if(this.path)for(let e=0;e<this.path.length;e++)this.H(this.path.get(e))}H(e){if(e.length===0)throw this.Z("Document fields must not be empty");if(Qp(this.dataSource)&&ew.test(e))throw this.Z('Document fields cannot begin and end with "__"')}}class nw{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||Fc(e)}ce(e,t,n,i=!1){return new kc({dataSource:e,methodName:t,targetDoc:n,path:sn.emptyPath(),arrayElement:!1,hasConverter:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function em(s){const e=s._freezeSettings(),t=Fc(s._databaseId);return new nw(s._databaseId,!!e.ignoreUndefinedProperties,t)}function iw(s,e,t,n,i,r={}){const a=s.ce(r.merge||r.mergeFields?2:0,e,t,i);im("Data must be an object, but it was:",a,n);const o=tm(n,a);let l,c;if(r.merge)l=new kr(a.fieldMask),c=a.fieldTransforms;else if(r.mergeFields){const h=[];for(const u of r.mergeFields){const d=Hc(e,u,t);if(!a.contains(d))throw new ge(re.INVALID_ARGUMENT,`Field '${d}' is specified in your field mask but missing from your input data.`);ow(h,d)||h.push(d)}l=new kr(h),c=a.fieldTransforms.filter(u=>l.covers(u.field))}else l=null,c=a.fieldTransforms;return new tw(new Rn(o),l,c)}class Vc extends Bc{_toFieldTransform(e){return new CA(e.path,new Gp)}isEqual(e){return e instanceof Vc}}function sw(s,e,t,n=!1){return zc(t,s.ce(n?4:3,e))}function zc(s,e){if(nm(s=zs(s)))return im("Unsupported field value:",e,s),tm(s,e);if(s instanceof Bc)return function(n,i){if(!Qp(i.dataSource))throw i.Z(`${n._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Z(`${n._methodName}() is not currently supported inside arrays`);const r=n._toFieldTransform(i);r&&i.fieldTransforms.push(r)}(s,e),null;if(s===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),s instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.Z("Nested arrays are not supported");return function(n,i){const r=[];let a=0;for(const o of n){let l=zc(o,i.X(a));l==null&&(l={nullValue:"NULL_VALUE"}),r.push(l),a++}return{arrayValue:{values:r}}}(s,e)}return function(n,i){if((n=zs(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return TA(i.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const r=wt.fromDate(n);return{timestampValue:nc(i.serializer,r)}}if(n instanceof wt){const r=new wt(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:nc(i.serializer,r)}}if(n instanceof Vn)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof yn)return{bytesValue:FA(i.serializer,n._byteString)};if(n instanceof At){const r=i.databaseId,a=n.firestore._databaseId;if(!a.isEqual(r))throw i.Z(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:Uc(n.firestore._databaseId||i.databaseId,n._key.path)}}if(n instanceof Pn)return function(a,o){const l=a instanceof Pn?a.toArray():a;return{mapValue:{fields:{[Fp]:{stringValue:Op},[Xa]:{arrayValue:{values:l.map(h=>{if(typeof h!="number")throw o.Z("VectorValues must only contain numeric values.");return Hp(o.serializer,h)})}}}}}}(n,i);if(jp(n))return n._toProto(i.serializer);throw i.Z(`Unsupported field value: ${lo(n)}`)}(s,e)}function tm(s,e){const t={};return function(i){for(const r in i)if(Object.prototype.hasOwnProperty.call(i,r))return!1;return!0}(s)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):ho(s,(n,i)=>{const r=zc(i,e.J(n));r!=null&&(t[n]=r)}),{mapValue:{fields:t}}}function nm(s){return!(typeof s!="object"||s===null||s instanceof Array||s instanceof Date||s instanceof wt||s instanceof Vn||s instanceof yn||s instanceof At||s instanceof Bc||s instanceof Pn||jp(s))}function im(s,e,t){if(!nm(t)||!Ip(t)){const n=lo(t);throw n==="an object"?e.Z(s+" a custom object"):e.Z(s+" "+n)}}function Hc(s,e,t){if((e=zs(e))instanceof Zp)return e._internalPath;if(typeof e=="string")return aw(s,e);throw Ya("Field path arguments must be of type string or ",s,!1,void 0,t)}const rw=new RegExp("[~\\*/\\[\\]]");function aw(s,e,t){if(e.search(rw)>=0)throw Ya(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,s,!1,void 0,t);try{return new Zp(...e.split("."))._internalPath}catch{throw Ya(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,s,!1,void 0,t)}}function Ya(s,e,t,n,i){const r=n&&!n.isEmpty(),a=i!==void 0;let o=`Function ${e}() called with invalid data`;t&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(r||a)&&(l+=" (found",r&&(l+=` in field ${n}`),a&&(l+=` in document ${i}`),l+=")"),new ge(re.INVALID_ARGUMENT,o+s+l)}function ow(s,e){return s.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gc{}class cw extends Gc{}function hw(s,e,...t){let n=[];e instanceof Gc&&n.push(e),n=n.concat(t),function(r){const a=r.filter(l=>l instanceof Wc).length,o=r.filter(l=>l instanceof mo).length;if(a>1||a>0&&o>0)throw new ge(re.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(n);for(const i of n)s=i._apply(s);return s}class mo extends cw{constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,this.type="where"}static _create(e,t,n){return new mo(e,t,n)}_apply(e){const t=this._parse(e);return am(e._query,t),new Zs(e.firestore,e.converter,tc(e._query,t))}_parse(e){const t=em(e.firestore);return function(r,a,o,l,c,h,u){let d;if(c.isKeyField()){if(h==="array-contains"||h==="array-contains-any")throw new ge(re.INVALID_ARGUMENT,`Invalid Query. You can't perform '${h}' queries on documentId().`);if(h==="in"||h==="not-in"){Jd(u,h);const g=[];for(const v of u)g.push(Yd(l,r,v));d={arrayValue:{values:g}}}else d=Yd(l,r,u)}else h!=="in"&&h!=="not-in"&&h!=="array-contains-any"||Jd(u,h),d=sw(o,a,u,h==="in"||h==="not-in");return Ln.create(c,h,d)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}function uw(s,e,t){const n=e,i=Hc("where",s);return mo._create(i,n,t)}class Wc extends Gc{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Wc(e,t)}_parse(e){const t=this._queryConstraints.map(n=>n._parse(e)).filter(n=>n.getFilters().length>0);return t.length===1?t[0]:Xr.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(i,r){let a=i;const o=r.getFlattenedFilters();for(const l of o)am(a,l),a=tc(a,l)}(e._query,t),new Zs(e.firestore,e.converter,tc(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}function Yd(s,e,t){if(typeof(t=zs(t))=="string"){if(t==="")throw new ge(re.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!EA(e)&&t.indexOf("/")!==-1)throw new ge(re.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const n=e.path.child(Et.fromString(t));if(!Ot.isDocumentKey(n))throw new ge(re.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${n}' is not because it has an odd number of segments (${n.length}).`);return zd(s,new Ot(n))}if(t instanceof At)return zd(s,t._key);throw new ge(re.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${lo(t)}.`)}function Jd(s,e){if(!Array.isArray(s)||s.length===0)throw new ge(re.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function am(s,e){const t=function(i,r){for(const a of i)for(const o of a.getFlattenedFilters())if(r.indexOf(o.op)>=0)return o.op;return null}(s.filters,function(i){switch(i){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new ge(re.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new ge(re.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class dw{convertValue(e,t="none"){switch(Ji(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Tt(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(Ur(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw yt(62114,{value:e})}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const n={};return ho(e,(i,r)=>{n[i]=this.convertValue(r,t)}),n}convertVectorValue(e){var n,i,r;const t=(r=(i=(n=e.fields)==null?void 0:n[Xa].arrayValue)==null?void 0:i.values)==null?void 0:r.map(a=>Tt(a.doubleValue));return new Pn(t)}convertGeoPoint(e){return new Vn(Tt(e.latitude),Tt(e.longitude))}convertArray(e,t){return(e.values||[]).map(n=>this.convertValue(n,t))}convertServerTimestamp(e,t){switch(t){case"previous":const n=Up(e);return n==null?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(Fr(e));default:return null}}convertTimestamp(e){const t=Yi(e);return new wt(t.seconds,t.nanos)}convertDocumentKey(e,t){const n=Et.fromString(e);un(qp(n),9688,{name:e});const i=new Nr(n.get(1),n.get(3)),r=new Ot(n.popFirst(5));return i.isEqual(t)||Dc(`Document ${r} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),r}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fw(s,e,t){let n;return n=s?t&&(t.merge||t.mergeFields)?s.toFirestore(e,t):s.toFirestore(e):e,n}class om extends dw{constructor(e){super(),this.firestore=e}convertBytes(e){return new yn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new At(this.firestore,null,t)}}function pw(s){const e=Oc((s=co(s,At)).firestore),t=new om(s.firestore);return jA(e,[s._key]).then(n=>{un(n.length===1,15618);const i=n[0];return new sm(s.firestore,t,s._key,i.isFoundDocument()?i:null,s.converter)})}function mw(s){(function(i){if(i.limitType==="L"&&i.explicitOrderBy.length===0)throw new ge(re.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")})((s=co(s,Zs))._query);const e=Oc(s.firestore),t=new om(s.firestore);return KA(e,s._query).then(n=>{const i=n.map(r=>new rm(s.firestore,t,r.key,r,s.converter));return s._query.limitType==="L"&&i.reverse(),new lw(s,i)})}function gw(s,e,t){const n=fw((s=co(s,At)).converter,e,t),i=iw(em(s.firestore),"setDoc",s._key,n,s.converter!==null,t);return qA(Oc(s.firestore),[i.toMutation(s._key,Mr.none())])}function Zd(){return new Vc("serverTimestamp")}const Qd="4.14.1";(function(){XT(`${DT}_lite`),Ha(new Ir("firestore/lite",(e,{instanceIdentifier:t,options:n})=>{const i=e.getProvider("app").getImmediate(),r=new po(new jT(e.getProvider("auth-internal")),new JT(i,e.getProvider("app-check-internal")),QT(i,t),i);return n&&r._setSettings(n),r},"PUBLIC").setMultipleInstances(!0)),Ls("firestore-lite",Qd,""),Ls("firestore-lite",Qd,"esm2020")})();var _w="firebase",vw="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ls(_w,vw,"app");const go={apiKey:"AIzaSyBjX6jAQXqm_QAy_-I_AEbpybJaOWmOZuc",authDomain:"bananaallergy-76b61.firebaseapp.com",projectId:"bananaallergy-76b61",storageBucket:"bananaallergy-76b61.firebasestorage.app",messagingSenderId:"199259846809",appId:"1:199259846809:web:db3e1979c978eff63a6008",measurementId:"G-SNKL3G0TH6"};console.log("[Firebase Config projectId]",go.projectId);console.log("[Firebase Config authDomain]",go.authDomain);console.log("[Firebase Config apiKey]",go.apiKey);const lm=Sp(go);console.log("[Firebase App name]",lm.name);const Xc=JA(lm),cm="players",hm="rankings",yw=6e3;function um(s){return String(s||"").trim().toLowerCase()}function $c(s,e){let t=null;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error(`${e} timeout`)),yw)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}async function ef(s){const e=um(s);if(!e)return null;const t=await $c(pw(Jp(Xc,cm,e)),"player load");return t.exists()?t.data():null}async function xw(s){const e=um(s==null?void 0:s.nickname);if(!e)throw new Error("missing nickname");const t={playerId:e,nickname:s.nickname,code:s.code,diamond:Math.floor(s.diamond||0),bestScore:Math.floor(s.bestScore||0),version:Ki,upgrades:s.upgrades||{},updatedAt:Zd()},n={playerId:e,nickname:s.nickname,bestScore:Math.floor(s.bestScore||0),version:Ki,updatedAt:Zd()};return await tf(cm,e,t,"players"),await tf(hm,e,n,"rankings"),t}async function Ew(s=10){const e=hw(QA(Xc,hm),uw("version","==",Ki));return(await $c(mw(e),"ranking load")).docs.map(n=>{const i=n.data();return{nickname:i.nickname||n.id,bestScore:Math.floor(i.bestScore||0)}}).sort((n,i)=>i.bestScore-n.bestScore).slice(0,s).map((n,i)=>({...n,rank:i+1}))}async function tf(s,e,t,n){console.log("[Firestore path]",s,e),n==="players"?(console.log("[players payload keys]",Object.keys(t)),console.log("[players payload]",t)):n==="rankings"&&(console.log("[rankings payload keys]",Object.keys(t)),console.log("[rankings payload]",t));try{await $c(gw(Jp(Xc,s,e),t,{merge:!0}),`${n} save`)}catch(i){throw console.error("[Firestore Error Code]",i==null?void 0:i.code),console.error("[Firestore Error Message]",i==null?void 0:i.message),console.error("[Firestore Error Full]",i),i}}document.fonts&&(document.fonts.load("400 16px PretendardGame"),document.fonts.load("700 16px PretendardGame"),document.fonts.load("900 24px PretendardGame"),document.fonts.load('400 16px "Press Start 2P"'));window.addEventListener("contextmenu",s=>s.preventDefault());document.addEventListener("gesturestart",s=>s.preventDefault());const nf=()=>window.matchMedia("(pointer:coarse)").matches||"ontouchstart"in window,dm=new Map;for(const[s,e]of Object.entries($i))for(const t of e)dm.set(t[0],{tier:s,tag:t[3]});class Mw{constructor(){var t,n,i;this.game=null,this.$title=document.getElementById("screen-title"),this.$menu=document.getElementById("screen-menu"),this.$upgrade=document.getElementById("screen-upgrade"),this.$uiOverlay=document.getElementById("ui-overlay"),this._desiredBgm="title",this._loginBusy=!1,Qf(),Ac(),document.getElementById("btn-new-game").addEventListener("click",()=>{Ge("uiClick"),this._onNewGameLogin()}),document.getElementById("btn-continue").addEventListener("click",()=>{Ge("uiClick"),this._onContinueLogin()}),document.getElementById("inp-code").addEventListener("keydown",r=>{r.key==="Enter"&&this._onContinueLogin()}),document.getElementById("btn-play").addEventListener("click",()=>{Ge("gameStart"),this._startGame()}),document.getElementById("btn-upgrade").addEventListener("click",()=>{Ge("uiClick"),this._showUpgrade()}),(t=document.getElementById("btn-ranking"))==null||t.addEventListener("click",()=>{Ge("uiClick"),this._showRanking()}),document.getElementById("btn-logout").addEventListener("click",()=>{Ge("uiClick"),this._showTitle()}),document.getElementById("btn-upgrade-back").addEventListener("click",()=>{Ge("uiClick"),this._showMenu()}),(n=document.getElementById("btn-pause"))==null||n.addEventListener("click",()=>this._showPauseMenu()),(i=document.getElementById("btn-stats"))==null||i.addEventListener("click",()=>this._showStatsPanel()),window.addEventListener("game:restart",()=>this._startGame()),window.addEventListener("game:menu",()=>this._showMenu()),window.addEventListener("game:ranking",()=>this._showRanking()),window.addEventListener("game:profile-save",r=>{var a;return this._saveCloud(((a=r.detail)==null?void 0:a.reason)||"game")});const e=localStorage.getItem("ammang_last_user");if(e){const[r,a]=e.split("|");r&&a&&(document.getElementById("inp-nick").value=r,document.getElementById("inp-code").value=a)}this._showTitle(),this._ensurePauseOverlay(),this._ensureStatsOverlay(),this._initGame(),this._bindAudioUnlock()}_playBgm(e){this._desiredBgm=e,Vl(),zM(e)}_bindAudioUnlock(){const e=()=>{Vl(),this._playBgm(this._desiredBgm||"title")};window.addEventListener("pointerdown",e),window.addEventListener("touchstart",e,{passive:!0}),window.addEventListener("keydown",e),document.addEventListener("visibilitychange",()=>{document.hidden||this._playBgm(this._desiredBgm||"title")})}_initGame(){const e=document.getElementById("game-canvas");this.game=new fb(e)}_showTitle(){var e,t,n;(t=(e=this.game)==null?void 0:e.stopGameSession)==null||t.call(e),(n=this.game)!=null&&n.canvas&&(this.game.canvas.style.visibility="hidden"),this._hideRunOverlays(),this.$title.classList.remove("hidden"),this.$menu.classList.add("hidden"),this.$upgrade.classList.add("hidden"),this.$uiOverlay.classList.add("hidden"),this._playBgm("title")}_hideRunOverlays(){var t,n,i;(t=document.getElementById("gameover-overlay"))==null||t.remove();const e=document.getElementById("augment-overlay");e&&(e.style.display="none"),(n=document.getElementById("pause-overlay"))==null||n.classList.remove("show"),(i=document.getElementById("stats-overlay"))==null||i.classList.remove("show"),this.game&&(this.game.paused=!1)}_ensurePauseOverlay(){if(document.getElementById("pause-overlay"))return;const e=document.createElement("div");e.id="pause-overlay",e.innerHTML=`
      <div class="pause-box">
...
${this._firestoreErrorText(e)}`)}}_renderRanking(e){var n;(n=document.getElementById("ranking-overlay"))==null||n.remove();const t=document.createElement("div");t.id="ranking-overlay",t.innerHTML=`
      ...
      </div>`,document.getElementById("stage").appendChild(t),t.querySelector(".ranking-close").addEventListener("click",()=>t.remove())}}const fm=new Mw;window.forceStartGame=()=>{Gl("debug","0000"),fm._startGame()};window.saveCloudProfileNow=()=>fm._saveCloud("debug");
